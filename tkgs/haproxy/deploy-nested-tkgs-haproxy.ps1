# deploy tkgs haproxy
# https://github.com/lamw/vsphere-with-tanzu-basic-automated-lab-deployment#enable-workload-management
# https://zercurity.medium.com/deploying-ha-proxy-on-vsphere-7-with-tanzu-kubernetes-grid-service-tkgs-796a6ab52913
...
$VIServer = "vcsa-01.haas-509.pez.vmware.com"
$VIUsername = "administrator@vsphere.local"
$VIPassword = "vXI81jB9c2mLzc0f6F!"

# Full Path to both the Nested ESXi 7.0 VA, Extracted VCSA 7.0 ISO & HA Proxy OVAs
$NestedESXiApplianceOVA = "C:\Users\Administrator\Downloads\Nested_ESXi7.0u1_Appliance_Template_v1.ova"
$VCSAInstallerPath = "E:\"
$HAProxyOVA = "C:\Users\Administrator\Downloads\vmware-haproxy-v0.1.8.ova"
...
$NestedESXiHostnameToIPs = @{
    "tanzu-esxi-1" = "10.212.160.112"
    "tanzu-esxi-2" = "10.212.160.113"
    "tanzu-esxi-3" = "10.212.160.114"
}
...
$VCSADisplayName = "vcsa-02"
$VCSAIPAddress = "10.212.160.111"
$VCSAHostname = "vcsa-02.haas-509.pez.vmware.com" #Change to IP if you don't have valid DNS
$VCSAPrefix = "24"
...
$HAProxyManagementIPAddress = "10.212.160.116/24" # Format is IP Address/CIDR Prefix
$HAProxyHostname = "tanzu-haproxy-1.haas-509.pez.vmware.com"
$HAProxyPort = "5556"
$HAProxyWorkloadIPAddress = "10.212.161.128/24" # Format is IP Address/CIDR Prefix
$HAProxyWorkloadGateway = "10.212.161.1"
$HAProxyWorkloadNetworkIPRange = "10.212.161.128/25" # Format is Network CIDR Notation
